(function(data, textModules) {
    ...
    Template.prototype = {
                        ...
                        if (aKey.length) {
                            if (data[aKey[0]] === undefined) {
                                if (data.$$parentObject === undefined) {
                                    ...
                                    throw new Error('expression:' + $0 + ',' + aKey[0] + 'undefined');
                                }
        ...
        _valueHandler: function(value, expression, data) {
            ...
            function getValue(value) {
                ...
                throw new Error(aCurrentHandler[0] + 'is not a function, or is not defined');
            }
        ...
        _for: function(ruleTree, data, expression) {
            ...
            throw new Error(lastExperssion + 'loop operation is not supported');
        },
        ...
        toHtml: function(value) {
            if (Template.isType.isArray(value)) {
                ...
                value.forEach(function(item) {
                    ...
                    result += '<' + tagName + '>' + item.innerText + '</' + tagName + '>';
                })
                return result;
            }
    ...
    for (var i = 0; i < data.length; i++) {
        result += (function(obj) {
            var template = new Template({
                template: textModules[obj.componentName],
                data: obj
            });
            return template.init();
        })(data[i])
